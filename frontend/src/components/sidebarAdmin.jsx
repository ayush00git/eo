"use client";
import { Sidebar, Calendar, SquareCheck, LayoutList,LogOut, LayoutDashboard, User, User2 } from 'lucide-react'
...
const handleLogout=()=>{
  ...
  return (
    ...
    <div className={`bg-white z-100  justify-between pb-20 text-gray-500 ${isopen?'w-1/7':'w-fit'} h-screen text-lg  drop-shadow-2xl`}>
      ...
      <div className='items-center justify-start px-5 pb-20 flex' onClick={handleLogout}>
        <LogOut className='ml-2 mr-3' />
